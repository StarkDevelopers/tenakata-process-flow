module.exports = {
  ...
  'CREDIT_SALES': '/ussd_credit_sale_purchases?user_id=[USER_ID]&phone=[PHONE_NUMBER]&country_code=[COUNTRY_CODE]' +
    '&date=[DATE]&amount=[AMOUNT]&item_list=[DETAILS]&payment_type=[PAYMENT_TYPE]&id_no=[DESCRIPTION]&sales_purchases=[SALES_OR_PURCHASE]',
  'CREDIT_MONEY_OUT': '/ussd_credit_sale_purchases?user_id=[USER_ID]&phone=[PHONE_NUMBER]&country_code=[COUNTRY_CODE]' +
    '&date=[DATE]&amount=[AMOUNT]&item_list=[DETAILS]&payment_type=[PAYMENT_TYPE]&id_no=[DESCRIPTION]&sales_purchases=[SALES_OR_PURCHASE]' +
